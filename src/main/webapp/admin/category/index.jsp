    ...
    <div class="main-panel">
      ...
      <div class="content">
       ...
       String err = request.getParameter("err");
	   	if("1".equals(msg)){
	   		out.print("<span style=\"background: #33CCFF; color: white; font-weight: bold; padding: 5px; \">Thêm danh mục thành công!</span>");
	   	}
	   	if("2".equals(msg)){
	   		out.print("<span style=\"background: #33CCFF; color: white; font-weight: bold; padding: 5px; \">Sửa danh mục thành công!</span>");
	   	}
	   	if("3".equals(msg)){
	   		out.print("<span style=\"background: #33CCFF; color: white; font-weight: bold; padding: 5px; \">Xóa danh mục thành công!</span>");
	   	}
	   	if("1".equals(err)){
