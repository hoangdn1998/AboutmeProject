    ...
    <div class="main-panel">
      ...
      <div class="content">
	      ...
	      String err = request.getParameter("err");
				if("1".equals(err)){
			    	out.print("<span style=\"background: #33CCFF; color: red; font-weight: bold; padding: 5px; \">không tìm thấy dự án!</span>");
			  	}
		  %>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="col-sm-6" style="text-align: right;">
	                <ul class="pagination">
		                 <li class="paginate_button previous disabled" aria-controls="dataTables-example" tabindex="0" id="dataTables-example_previous"><a href="<%=request.getContextPath()%>/admin/projects?page=<%=currentPage-1%>&search=<%=name%>">Trang trước</a></li>
		                  <% 
			                 String active = "";
		                 ...
		                 %>
		                 <li class="paginate_button <%=active%>" aria-controls="dataTables-example" tabindex="0"><a href="<%=request.getContextPath()%>/admin/projects?page=<%=i%>&search=<%=name%>"><%=i%></a></li>
						<%} %>
		                 <li class="paginate_button next" aria-controls="dataTables-example" tabindex="0" id="dataTables-example_next"><a href="<%=request.getContextPath()%>/admin/projects?page=<%=currentPage+1%>&search=<%=name%>">Trang tiếp</a></li>
	             	</ul>
                </div>
                </div>
                 <%} %>
