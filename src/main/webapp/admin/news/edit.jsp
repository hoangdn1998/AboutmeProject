  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
          ...
          <div class="col-md-12">
		    ...
		    if(objnew != null){
		    	name = objnew.getName();
		    	cat_id = String.valueOf(objnew.getCategory().getCategory_id());
		  	...
		  	if("1".equals(err)){
		    	out.print("<span style=\"background: #33CCFF; color: red; font-weight: bold; padding: 5px; \">Sửa tin tức thất bại!</span>");
		  	}
    		%>
              ...
              <div class="card-body">
                <form id="news-form" action="<%=request.getContextPath()%>/admin/news/edit?id=<%=objnew.getNews_id()%>" method="post" enctype="multipart/form-data" >
                  <div class="row">
                    <div class="col-md-10 px-1">
                      <div class="form-group">
                        <label>Nhập tên tin tức</label>
                        <input type="text" name="name" value="<%if(name != null) out.print(name);%>" class="form-control" id ="name" placeholder="Nhập tin tức"/>
