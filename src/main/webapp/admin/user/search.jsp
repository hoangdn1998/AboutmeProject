            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="col-sm-6" style="text-align: right;">
	                <ul class="pagination">
		                 <li class="paginate_button previous disabled" aria-controls="dataTables-example" tabindex="0" id="dataTables-example_previous"><a href="<%=request.getContextPath()%>/admin/user/search?page=<%=currentPage-1%>&search=<%=name%>">Trang trước</a></li>
		                  <% 
			                 String active = "";
		                 ...
		                 %>
		                 <li class="paginate_button <%=active%>" aria-controls="dataTables-example" tabindex="0"><a href="<%=request.getContextPath()%>/admin/user/search?page=<%=i%>&search=<%=name%>"><%=i%></a></li>
						<%} %>
		                 <li class="paginate_button next" aria-controls="dataTables-example" tabindex="0" id="dataTables-example_next"><a href="<%=request.getContextPath()%>/admin/user/search?page=<%=currentPage+1%>&search=<%=name%>">Trang tiếp</a></li>
	             	</ul>
                </div>
                </div>
                 <%} %>
