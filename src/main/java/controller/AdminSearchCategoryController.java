...
public class AdminSearchCategoryController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	CategoryDAO categoryDAO;
       
    public AdminSearchCategoryController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(numberOfItems == 0) {
			response.sendRedirect(request.getContextPath()+ "/admin/category/search.jsp?err=1");
			return;
		}
